...
public:
    ...
    SketchPlane(const math::Vec3& origin, const math::Vec3& normal, const math::Vec3& xAxis);
    ...
    [[nodiscard]] bool rayIntersect(const math::Vec3& rayOrigin, const math::Vec3& rayDir,
